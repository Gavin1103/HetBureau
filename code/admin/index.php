...
<body>
    ...
    <a href="../forms/formulieren_fase_1.php?formNumber=form1">Formulier fase 1</a>
    <a href="../forms/formulieren_fase_2.php?formNumber=form2">Formulier fase 2</a>
    <a href="../forms/formulieren_fase_3.php?formNumber=form3">Formulier fase 3</a>
    <a href="../forms/formulieren_fase_4.php?formNumber=form4">Formulier fase 4</a>
    <br>
    <br>
